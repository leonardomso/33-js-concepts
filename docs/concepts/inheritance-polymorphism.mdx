...
<Tip>
**The DRY Principle:** Inheritance helps you "Don't Repeat Yourself". Write common code once in the parent class, and all children automatically benefit — including bug fixes and improvements!
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="The Gorilla-Banana Problem" icon="newspaper" href="https://www.johndcook.com/blog/2011/07/19/you-wanted-banana/">
    The origin of the famous inheritance criticism
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="JavaScript ES6 Classes and Inheritance" icon="video" href="https://www.youtube.com/watch?v=RBLIm5LMrmc">
    Traversy Media's tutorial on ES6 class inheritance
  </Card>
