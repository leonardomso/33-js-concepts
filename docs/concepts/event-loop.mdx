---
title: "Event Loop, Timers and Scheduling"
description: "Understanding JavaScript's concurrency model, message queues, and how to schedule code execution"
---

## The Restaurant Kitchen: A Real-World Analogy
...
JavaScript solves this by **delegating** long-running tasks to the browser (or Node.js), which handles them in the background:
...
<Tabs>
  ...
  <Tab title="requestIdleCallback">
    Run code during browser idle time:
