---
title: "HTTP & Fetch"
description: "Learn how to make network requests in JavaScript using the Fetch API, handle HTTP responses, parse JSON data, and avoid common error handling mistakes"
---
...
The simplest fetch call retrieves data from a URL. By default, `fetch()` uses the **GET** method, so you don't need to specify it. There are two ways to write this:
