---
title: "IIFE, Modules & Namespaces in JavaScript Explained"
sidebarTitle: "IIFE, Modules & Namespaces"
description: "Master JavaScript code organization with IIFEs, namespaces, and ES6 modules. Learn private scope, exports, dynamic imports, and avoid common mistakes."
---
...
**[IIFE](https://developer.mozilla.org/en-US/docs/Glossary/IIFE)** stands for **Immediately Invoked Function Expression**. It's a function that runs as soon as it's defined.
