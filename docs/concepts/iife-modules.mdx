...
import sayHello from './greeting.js';  // Same thing, different name
import xyz from './greeting.js';        // Still works!
...
// Common use: Conditional loading
if (userWantsCharts) {
...
<CardGroup cols={2}>
  ...
  <Card title="Expression vs Statement" icon="code" href="/concepts/expression-statement">
    The difference between code that produces values and code that performs actions
  </Card>
