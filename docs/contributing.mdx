...
<Tip>
Before writing or updating concept content, read the [Editorial Style Guide](/editorial-style-guide). It defines intro standards, research validation rules, and the requirement to test examples in `tests/` files.
</Tip>
