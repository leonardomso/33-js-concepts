<h1 align="center">
<br>
  <a href="https://github.com/leonardomso/33"><img src="https://i.imgur.com/dsHmk6H.jpg" alt="৩৩টি এমন কনসেপ্ট যেইগুলো প্রতিটি JavaScript ডেভেলপার এর জানা উচিত" width=200" /></a>
  <br>
    <br>
  ৩৩টি এমন কনসেপ্ট যেইগুলো প্রতিটি JavaScript ডেভেলপার এর জানা উচিত
  <br><br>
</h1>

## ভূমিকা

এই রিপোসিটোরিটি JavaScript ডেভেলপারদের তাদের কনসেপ্ট গুলো ভালোভাবে আয়ত্ত করতে সহায়তা করার উদ্দেশ্যে তৈরি করা হয়েছিল। এটি কোনো প্রয়োজনীয়তা নয় বরং ভবিষ্যতের ডেভেলপারদের জন্য একটি গাইড। এটি [স্টিফেন কার্টিসের](https://twitter.com/stephenthecurt) লেখা একটি নিবন্ধের উপর ভিত্তি করে এবং আপনি এটি [এখানে](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1) পড়তে পারেন।

## সম্প্রদায়

আপনি চাইলে আপনার নিজের রিক্যাপ বা রিভিউতে একটি লিঙ্ক যোগ করে একটি PR জমা দিতে পারেন। আপনি যদি রেপোটিকে আপনার স্থানীয় ভাষায় অনুবাদ করতে চান, অনুগ্রহ করে নির্দ্বিধায় তা করুন।

এই রিপোর সমস্ত অনুবাদ নীচে তালিকাভুক্ত করা হবে:
...
1. **[Call Stack](#১-call-stack)**
2. **[Primitive Types](#২-primitive-types)**
3. **[Value Types and Reference Types](#৩-value-types-and-reference-types)**
4. **[Implicit, Explicit, Nominal, Structuring and Duck Typing](#৪-implicit-explicit-nominal-structuring-and-duck-typing)**
5. **[== vs === vs typeof](#৫--vs--vs-typeof)**
6. **[Function Scope, Block Scope and Lexical Scope](#৬-function-scope-block-scope-and-lexical-scope)**
7. **[Expression vs Statement](#৭-expression-vs-statement)**
8. **[IIFE, Modules and Namespaces](#৮-iife-modules-and-namespaces)**
9. **[Message Queue and Event Loop](#৯-message-queue-and-event-loop)**
10. **[setTimeout, setInterval and requestAnimationFrame](#১০-settimeout-setinterval-and-requestanimationframe)**
11. **[JavaScript Engines](#১১-javascript-engines)**
12. **[Bitwise Operators, Type Arrays and Array Buffers](#১২-bitwise-operators-type-arrays-and-array-buffers)**
13. **[DOM and Layout Trees](#১৩-dom-and-layout-trees)**
14. **[Factories and Classes](#১৪-factories-and-classes)**
15. **[this, call, apply and bind](#১৫-this-call-apply-and-bind)**
16. **[new, Constructor, instanceof and Instances](#১৬-new-constructor-instanceof-and-instances)**
17. **[Prototype Inheritance and Prototype Chain](#১৭-prototype-inheritance-and-prototype-chain)**
18. **[Object.create and Object.assign](#১৮-objectcreate-and-objectassign)**
19. **[map, reduce, filter](#১৯-map-reduce-filter)**
20. **[Pure Functions, Side Effects, State Mutation and Event Propagation](#২০-pure-functions-side-effects-state-mutation-and-event-propagation)**
21. **[Closures](#২১-closures)**
22. **[High Order Functions](#২২-high-order-functions)**
23. **[Recursion](#২৩-recursion)**
24. **[Collections and Generators](#২৪-collections-and-generators)**
25. **[Promises](#২৫-promises)**
26. **[async/await](#২৬-asyncawait)**
27. **[Data Structures](#২৭-data-structures)**
28. **[Expensive Operation and Big O Notation](#২৮-expensive-operation-and-big-o-notation)**
29. **[Algorithms](#২৯-algorithms)**
30. **[Inheritance, Polymorphism and Code Reuse](#৩০-inheritance-polymorphism-and-code-reuse)**
31. **[Design Patterns](#৩১-design-patterns)**
32. **[Partial Applications, Currying, Compose and Pipe](#৩২-partial-applications-currying-compose-and-pipe)**
33. **[Clean Code](#৩৩-clean-code)**
