...
ജാവാസ്ക്രിപ്റ്റിൽ അവരുടെ ആശയങ്ങൾ മാസ്റ്റർ ചെയ്യാൻ ഡവലപ്പർമാരെ സഹായിക്കുക എന്ന ഉദ്ദേശത്തോടെയാണ് ഈ ശേഖരം സൃഷ്ടിച്ചത്. ഇത് ഒരു ആവശ്യകതയല്ല, ഭാവിയിലെ പഠനത്തിനുള്ള വഴികാട്ടിയാണ്. എഴുതിയ ഒരു ലേഖനത്തെ അടിസ്ഥാനമാക്കിയുള്ളതാണ് [Stephen Curtis](https://twitter.com/stephenthecurt) നിങ്ങൾക്ക് അത് വായിക്കാനും കഴിയും [ഇവിടെ](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1).

**🚀 GitHub [2018-ലെ മികച്ച ഓപ്പൺ സോഴ്‌സ് പ്രോജക്ടുകളിലൊന്നായി!](https://blog.github.com/2018-12-13-new-open-source-projects/)**
...
- [മലയാളം (Malyalam)](https://github.com/IamLucif3r/33-js-concepts) - Anmol Singh Yadav
...
## <a id="table-of-contents">ഉള്ളടക്ക പട്ടിക</a>

1. **[Call Stack](#1-call-stack)**
2. **[Primitive Types](#2-primitive-types)**
3. **[Value Types and റഫറൻസ് Types](#3-value-types-and-റഫറൻസ്-types)**
...
**[⬆ മുകളിലേയ്ക്ക്](#table-of-contents)**
...
- 🎥 [JavaScript റഫറൻസ് vs Primitive Types — Academind](https://www.youtube.com/watch?v=9ooYYRLdg_g)
- 🎥 [JavaScript Primitive Types — Simon Sez IT](https://www.youtube.com/watch?v=HsbWQsSCE5Y)
- 🎥 [Value Types and റഫറൻസ് Types in JavaScript — Programming with Mosh](https://www.youtube.com/watch?v=e-_mDyqm2oU)
...
- 📜 [Explaining Value vs. റഫറൻസ് in Javascript — Arnav Aggarwal](https://codeburst.io/explaining-value-vs-റഫറൻസ്-in-javascript-647a975e12a0)
- 📜 [Primitive Types & റഫറൻസ് Types in JavaScript — Bran van der Meer](https://gist.github.com/branneman/7fb06d8a74d7e6d4cbcf75c50fec599c)
- 📜 [Value Types, റഫറൻസ് Types and Scope in JavaScript — Ben Aston](https://medium.com/@benastontweet/lesson-1b-javascript-fundamentals-380f601ba851)
- 📜 [Back to roots: JavaScript Value vs റഫറൻസ് — Miro Koczka](https://medium.com/dailyjs/back-to-roots-javascript-value-vs-റഫറൻസ്-8fb69d587a18)
- 📜 [Grasp “By Value” and “By റഫറൻസ്” in JavaScript — Léna Faure](https://hackernoon.com/grasp-by-value-and-by-റഫറൻസ്-in-javascript-7ed75efa1293)
- 📜 [JavaScript റഫറൻസ് and Copy Variables — Vítor Capretz](https://hackernoon.com/javascript-റഫറൻസ്-and-copy-variables-b0103074fdf0)
- 📜 [JavaScript Primitive vs റഫറൻസ് Values](http://www.javascripttutorial.net/javascript-primitive-vs-റഫറൻസ്-values/)
- 📜 [JavaScript by റഫറൻസ് vs. by Value — nrabinowitz](https://stackoverflow.com/questions/6605640/javascript-by-റഫറൻസ്-vs-by-value)
- 📜 [JavaScript Interview Prep: Primitive vs. റഫറൻസ് Types — Mike Cronin](https://dev.to/mostlyfocusedmike/javascript-interview-prep-primitive-vs-റഫറൻസ്-types-3o4f)

### വീഡിയോകൾ

- 🎥 [Javascript Pass by Value vs Pass by റഫറൻസ് — techsith](https://www.youtube.com/watch?v=E-dAnFdq8k8)
- 🎥 [JavaScript Value vs റഫറൻസ് Types — Programming with Mosh](https://www.youtube.com/watch?v=fD0t_DKREbE)
...
- 📜 [Should I use === or == equality comparison operator in JavaScript? — Panu Pitkamaki](https://bytearcher.com/ലേഖനങ്ങൾ/equality-comparison-operator-javascript/)
...
- 📜 [ES6 Modules in Depth — Nicolás Bevacqua](https://ponyfoo.com/ലേഖനങ്ങൾ/es6-modules-in-depth)
...
- 📜 [call() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/റഫറൻസ്/Global_Objects/Function/call)
- 📜 [bind() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/റഫറൻസ്/Global_objects/Function/bind)
- 📜 [apply() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/റഫറൻസ്/Global_Objects/Function/apply)
...
- 📜 [Object.create() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/റഫറൻസ്/Global_Objects/Object/create)
- 📜 [Object.assign() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/റഫറൻസ്/Global_Objects/Object/assign)
...
- 📜 [How to deal with dirty side effects in your pure functional JavaScript — James Sinclair](https://jrsinclair.com/ലേഖനങ്ങൾ/2018/how-to-deal-with-dirty-side-effects-in-your-pure-functional-javascript/)
...
- 📜 [Higher Order Functions in JavaScript — John Hannah](https://www.lullabot.com/ലേഖനങ്ങൾ/higher-order-functions-in-javascript)
...
- 📜 [Generator — MDN web docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript/റഫറൻസ്/Global_Objects/Generator)
...
- 📜 [ES6 WeakMaps, Sets, and WeakSets in Depth — Nicolás Bevacqua](https://ponyfoo.com/ലേഖനങ്ങൾ/es6-weakmaps-sets-and-weaksets-in-depth)
...
- 📜 [ES6 Maps in Depth — Nicolás Bevacqua](https://ponyfoo.com/ലേഖനങ്ങൾ/es6-maps-in-depth)
...
- 📜 [Promise — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/റഫറൻസ്/Global_Objects/Promise)
...
- 📜 [ES6 Promises in Depth — Nicolás Bevacqua](https://ponyfoo.com/ലേഖനങ്ങൾ/es6-promises-in-depth)
...
- 📜 [Understanding JavaScript’s async await — Nicolás Bevacqua](https://ponyfoo.com/ലേഖനങ്ങൾ/understanding-javascript-async-await)
...
- 📜 [JavaScript: Promises and Why Async/Await Wins the Battle — Nick Parsons](https://dzone.com/ലേഖനങ്ങൾ/javascript-promises-and-why-asyncawait-wins-the-ba)
...
- 📜 [A Gentle Introduction to Functional JavaScript pt III: Functions for making functions — James Sinclair](https://jrsinclair.com/ലേഖനങ്ങൾ/2016/gentle-introduction-to-functional-javascript-functions/)
...
- 📜 [Functional Composition in Javascript — Joe Cortopassi](https://joecortopassi.com/ലേഖനങ്ങൾ/functional-composition-in-javascript/)
