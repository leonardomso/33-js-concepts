...
This repository was created to help the beginners to build their concepts in JavaScript. It is not a requirement, but a guide for future studies. It is based on an article written by [Stephen Curtis](https://twitter.com/stephenthecurt) and you must read it [here](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1).
...
Feel free to submit a PR adding a link to your own recaps or reviews. If you want to translate the repository into your native language,feel free to do so.

All the translations for this repository will be listed below:
...
- [Turkish](https://github.com/ilker0/33-js-concepts) — ?lker Demir
- [Russian](https://github.com/gumennii/33-js-concepts) — Mihail Gumennii
- [Ti?ng Vi?t](https://github.com/nguyentranchung/33-js-concepts) — Nguy?n Tr?n Chung
 ...
 * ?? [How to traverse the DOM in Javascript — Vojislav Gruji?](https://medium.com/javascript-in-plain-english/how-to-traverse-the-dom-in-javascript-d6555c335b4e)
