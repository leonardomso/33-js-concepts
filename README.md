...
<br>
  ...
  <br>
    <br>
  ३३ सिद्धान्ताः प्रत्येकः जावास्क्रिप्ट डेवलपरः जान्याः।
  <br><br>
</h1>
...
ईष्टतः डेवलपरानां जावास्क्रिप्टे सिद्धान्तानां प्रभुत्वं सहायतुं इयं संग्रहालयः स्थापितः। इष्टतः अनिवार्यतया नास्ति, किन्तु भविष्यवाणीकायां मार्गदर्शनं भवति। इयञ्च लेखः स्टीफेन् कर्टिस् नाम्ना लिखितः अत्र पठितुं शक्नोति। [इथे](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1).

**🚀 गिटहबेन एकः [२०१८ तपः ओपन स्रोतः परियोजनानां एकः] इति [यत्र] आदर्शः अपेक्ष्यते।(https://blog.github.com/2018-12-13-new-open-source-projects/)**

##  समुदायः

स्वतंत्रः पीआर सबमिट् कर्मणा अपनीयं पुनरावृत्तिस्य वा समीक्षायाः लिङ्कं जोडयिष्यन्तु। यदि रिपॉजिटरीं आपद्य भाषया अनुवादितुं इच्छते, कृपया स्वतन्त्रतायाम् अनुवादयितुं अनुवर्तिष्यतु।

<<<<<< master
इयं रिपॉजिटरीस्य सर्वाणि अनुवादाः नीचे सूचीकृताः भविष्यन्ति:
====
...
## <a id="table-of-contents">सूचीः विषयाः</a>

1. **[Call Stack](#1-call-stack)**
2. **[Primitive Types](#2-primitive-types)**
3. **[Value Types and सन्दर्भः Types](#3-value-types-and-सन्दर्भः-types)**
...
**[⬆ शीर्षे वापसः](#table-of-contents)**
=======
...
- 🎥 [JavaScript सन्दर्भः vs Primitive Types — Academind](https://www.youtube.com/watch?v=9ooYYRLdg_g)
- 🎥 [JavaScript Primitive Types — Simon Sez IT](https://www.youtube.com/watch?v=HsbWQsSCE5Y)
- 🎥 [Value Types and सन्दर्भः Types in JavaScript — Programming with Mosh](https://www.youtube.com/watch?v=e-_mDyqm2oU)
...
## 3. Value Types and सन्दर्भः Types

### लेखाः

- 📜 [Explaining Value vs. सन्दर्भः in Javascript — Arnav Aggarwal](https://codeburst.io/explaining-value-vs-सन्दर्भः-in-javascript-647a975e12a0)
- 📜 [Primitive Types & सन्दर्भः Types in JavaScript — Bran van der Meer](https://gist.github.com/branneman/7fb06d8a74d7e6d4cbcf75c50fec599c)
- 📜 [Value Types, सन्दर्भः Types and Scope in JavaScript — Ben Aston](https://medium.com/@benastontweet/lesson-1b-javascript-fundamentals-380f601ba851)
- 📜 [Back to roots: JavaScript Value vs सन्दर्भः — Miro Koczka](https://medium.com/dailyjs/back-to-roots-javascript-value-vs-सन्दर्भः-8fb69d587a18)
- 📜 [Grasp “By Value” and “By सन्दर्भः” in JavaScript — Léna Faure](https://hackernoon.com/grasp-by-value-and-by-सन्दर्भः-in-javascript-7ed75efa1293)
- 📜 [JavaScript सन्दर्भः and Copy Variables — Vítor Capretz](https://hackernoon.com/javascript-सन्दर्भः-and-copy-variables-b0103074fdf0)
- 📜 [JavaScript Primitive vs सन्दर्भः Values](http://www.javascripttutorial.net/javascript-primitive-vs-सन्दर्भः-values/)
- 📜 [JavaScript by सन्दर्भः vs. by Value — nrabinowitz](https://stackoverflow.com/questions/6605640/javascript-by-सन्दर्भः-vs-by-value)
- 📜 [JavaScript Interview Prep: Primitive vs. सन्दर्भः Types — Mike Cronin](https://dev.to/mostlyfocusedmike/javascript-interview-prep-primitive-vs-सन्दर्भः-types-3o4f)
...
- 🎥 [Javascript Pass by Value vs Pass by सन्दर्भः — techsith](https://www.youtube.com/watch?v=E-dAnFdq8k8)
- 🎥 [JavaScript Value vs सन्दर्भः Types — Programming with Mosh](https://www.youtube.com/watch?v=fD0t_DKREbE)
- 🎥 [VALORES vs REFERENCIAS en JAVASCRIPT - La Cocina del Código](https://www.youtube.com/watch?v=AvkyOrWkuQc)
- 🎥 [JavaScript - सन्दर्भः vs Primitive Values/ Types - Academind](https://www.youtube.com/watch?v=9ooYYRLdg_g) 
...
- 📜 [Should I use === or == equality comparison operator in JavaScript? — Panu Pitkamaki](https://bytearcher.com/लेखाः/equality-comparison-operator-javascript/)
...
- 📜 [ES6 Modules in Depth — Nicolás Bevacqua](https://ponyfoo.com/लेखाः/es6-modules-in-depth)
...
- 📜 [call() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/सन्दर्भः/Global_Objects/Function/call)
- 📜 [bind() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/सन्दर्भः/Global_objects/Function/bind)
- 📜 [apply() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/सन्दर्भः/Global_Objects/Function/apply)
...
- 📜 [Object.create() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/सन्दर्भः/Global_Objects/Object/create)
- 📜 [Object.assign() — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/सन्दर्भः/Global_Objects/Object/assign)
...
- 📜 [How to deal with dirty side effects in your pure functional JavaScript — James Sinclair](https://jrsinclair.com/लेखाः/2018/how-to-deal-with-dirty-side-effects-in-your-pure-functional-javascript/)
...
- 📜 [Higher Order Functions in JavaScript — John Hannah](https://www.lullabot.com/लेखाः/higher-order-functions-in-javascript)
...
- 📜 [Generator — MDN web docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript/सन्दर्भः/Global_Objects/Generator)
...
- 📜 [ES6 WeakMaps, Sets, and WeakSets in Depth — Nicolás Bevacqua](https://ponyfoo.com/लेखाः/es6-weakmaps-sets-and-weaksets-in-depth)
...
- 📜 [ES6 Maps in Depth — Nicolás Bevacqua](https://ponyfoo.com/लेखाः/es6-maps-in-depth)
...
- 📜 [Promise — MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/सन्दर्भः/Global_Objects/Promise)
...
- 📜 [ES6 Promises in Depth — Nicolás Bevacqua](https://ponyfoo.com/लेखाः/es6-promises-in-depth)
...
- 📜 [Understanding JavaScript’s async await — Nicolás Bevacqua](https://ponyfoo.com/लेखाः/understanding-javascript-async-await)
...
- 📜 [JavaScript: Promises and Why Async/Await Wins the Battle — Nick Parsons](https://dzone.com/लेखाः/javascript-promises-and-why-asyncawait-wins-the-ba)
...
- 📜 [A Gentle Introduction to Functional JavaScript pt III: Functions for making functions — James Sinclair](https://jrsinclair.com/लेखाः/2016/gentle-introduction-to-functional-javascript-functions/)
...
- 📜 [Functional Composition in Javascript — Joe Cortopassi](https://joecortopassi.com/लेखाः/functional-composition-in-javascript/)
