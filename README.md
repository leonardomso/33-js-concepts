...
This repository was created to help developers master key concepts in JavaScript. It is not a requirement, but rather a guide for future studies. It is based on an article written by [Stephen Curtis](https://twitter.com/stephenthecurt) that you can read [here](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1).
