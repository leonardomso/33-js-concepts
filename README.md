...
<br>
  ...
  <br>
    <br>
    33 sąvokos, kurias kiekvienas JavaScript programuotojas turėtų žinoti
  <br><br>
</h1>
...
**🚀 GitHub laiko mus vienu iš [geriausių atviro kodo projektų 2018 metais!](https://blog.github.com/2018-12-13-new-open-source-projects/)**

## Community

Jeigu norite išversti šią repozitoriją į kitą kalbą, nedvėjokite ir sukurkite PR originalioje repozitorijoje.

Visi vertimai šiai repozitorijai yra paminėti žemiau:
...
## <a id="table-of-contents">Turinys</a>

1. **[Kvietimų stekas](#1-call-stack)**
2. **[Primityvūs tipai](#2-primitive-types)**
3. **[Reikšmių tipai ir nuorodų tipai](#3-value-types-and-reference-types)**
4. **[Neišreikštinis, išreikštinis, vardinis, struktūrinis ir "ančių" tipavimas](#4-implicit-explicit-nominal-structuring-and-duck-typing)**
5. **[== prieš === prieš typeof](#5--vs--vs-typeof)**
6. **[Funkcijos, bloko ir leksikos apimtis](#6-function-scope-block-scope-and-lexical-scope)**
7. **[Išraiškos prieš teiginius](#7-expression-vs-statement)**
8. **[IIFE, moduliai ir Vardų erdvės](#8-iife-modules-and-namespaces)**
9. **[Pranešimų eilė ir įvykių ciklai](#9-message-queue-and-event-loop)**
10. **[setTimeout, setInterval ir requestAnimationFrame](#10-settimeout-setinterval-and-requestanimationframe)**
11. **[JavaScript vykdymo varikliai](#11-javascript-engines)**
12. **[Bitwise operatoriai, tipų masyvai ir masyvo buferiai](#12-bitwise-operators-type-arrays-and-array-buffers)**
13. **[DOM ir medžio hierarchija](#13-dom-and-layout-trees)**
14. **[Funkcijos "gamyklos" ir klasės](#14-factories-and-classes)**
15. **[this, call, apply ir bind](#15-this-call-apply-and-bind)**
16. **[new, konstruktoriai, instanceof ir paveldimumas](#16-new-constructor-instanceof-and-instances)**
17. **[Prototipai, paveldimumas ir prototipų grandis](#17-prototype-inheritance-and-prototype-chain)**
18. **[Object.create ir Object.assign](#18-objectcreate-and-objectassign)**
19. **[map, reduce, filter](#19-map-reduce-filter)**
20. **[Grynos funkcijos, pašaliniai efektai, būsenos mutacija ir DOM įvykių plitimas](#20-pure-functions-side-effects-state-mutation-and-event-propagation)**
21. **[Closures](#21-closures)**
22. **[Aukštos eilės funkcijos](#22-high-order-functions)**
23. **[Rekursija](#23-recursion)**
24. **[Kolekcijos ir generatoriai](#24-collections-and-generators)**
25. **[Promises (pažadai asinchroniniame programavime)](#25-promises)**
26. **[async/await](#26-asyncawait)**
27. **[Duomenų struktūros](#27-data-structures)**
28. **[Brangi operacija ir didžioji O notacija](#28-expensive-operation-and-big-o-notation)**
29. **[Algoritmai](#29-algorithms)**
30. **[Paveldimumas, Polimorfizmas ir Kodo fragmentų pernaudojimas](#30-inheritance-polymorphism-and-code-reuse)**
31. **[Dizaino modeliai](#31-design-patterns)**
32. **[Dalinis pritaikymas, currying, compose ir pipe](#32-partial-applications-currying-compose-and-pipe)**
33. **[Tvarkingas kodas](#33-clean-code)**
...
**[⬆ Atgal į viršų](#table-of-contents)**
...
## 3. Reikšmių tipai ir Nuorodų tipai
...
## 4. Neišreikštinis, Išreikštinis, Vardinis, Struktūrinis ir "ančių" tipavimas
...
## 6. Funkcijos, bloko ir leksikos apimtis
...
## 8. IIFE, Moduliai ir Vardų erdvės
...
## 9. Pranešimų eilė ir įvykių ciklai
...
## 10. setTimeout, setInterval ir requestAnimationFrame
...
## 11. JavaScript vykdymo varikliai
...
## 12. Bitwise operatoriai, Tipų masyvai ir Masyvo buferiai
...
## 14. Funkcijos "gamyklos" ir klasės
...
## 16. New, konstruktoriai, instanceof ir paveldimumas
...
## 17. Prototipai, paveldimumas ir prototipų grandis
...
## 18. Object.create ir Object.assign
...
## 20. Grynos funkcijos, pašaliniai efektai, būsenos mutacija ir DOM įvykių plitimas
...
## 22. Aukštos eilės funkcijos

Aukštos eilės funkcijos
...
## 25. Promises (pažadai asinchroniniame programavime)
...
## 28. Brangi operacija ir didžioji O notacija
...
## 30. Paveldimumas, Polimorfizmas ir Kodo fragmentų pernaudojimas
...
## 32. Dalinis pritaikymas, currying, compose ir pipe
