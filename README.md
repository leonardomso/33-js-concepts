...
## 1. काल स्टैक <a id="1-call-stack"></a>
...
## 2. साधारण प्रकार <a id="2-primitive-types"></a>
...
## 3. मूल्य-आधारित अर संदर्भ-आधारित प्रकार <a id="3-value-types-and-reference-types"></a>
...
## 4. अप्रकट, प्रकट, नामकरण, ढाँचा अर डक टाइपिंग <a id="4-implicit-explicit-nominal-structuring-and-duck-typing"></a>
...
## 5. दो बराबर (==) vs तीन बराबर (===) vs टाइप-ऑफ़ (typeof) <a id="5--vs--vs-typeof"></a>
...
## 6. फंक्शन स्कोप, ब्लॉक स्कोप अर लेक्सिकल स्कोप <a id="6-function-scope-block-scope-and-lexical-scope"></a>
...
## 7. एक्सप्रेशन बनाम स्टेटमेंट <a id="7-expression-vs-statement"></a>
...
## 8. IIFE, मॉड्यूल अर नेमस्पेस <a id="8-iife-modules-and-namespaces"></a>
...
## 9. मैसेज कतार अर इवेंट लूप <a id="9-message-queue-and-event-loop"></a>
...
## 10. setTimeout, setInterval and requestAnimationFrame <a id="10-settimeout-setinterval-and-requestanimationframe"></a>
...
## 11. जावास्क्रिप्ट इंजन <a id="11-javascript-engines"></a>
...
## 12. बिटवाइज़ ऑपरेटर, टाइप एरे अर एरे बफर <a id="12-bitwise-operators-type-arrays-and-array-buffers"></a>
...
## 13. DOM अर लेआउट ट्री <a id="13-dom-and-layout-trees"></a>
...
## 14. फैक्ट्री अर क्लास <a id="14-factories-and-classes"></a>
...
## 15. यह (this), कॉल, अप्लाई अर बाइंड <a id="15-this-call-apply-and-bind"></a>
...
## 16. न्यू (new), कंस्ट्रक्टर, उदाहरण-की (instanceof) अर उदाहरण <a id="16-new-constructor-instanceof-and-instances"></a>
...
## 17. प्रोटोटाइप विरासत अर प्रोटोटाइप चैन <a id="17-prototype-inheritance-and-prototype-chain"></a>
...
## 18. Object.create अर Object.assign <a id="18-objectcreate-and-objectassign"></a>
...
## 19. मैप, रिड्यूस, फिल्टर <a id="19-map-reduce-filter"></a>
...
## 20. शुद्ध फंक्शन, साइड इफेक्ट, स्टेट म्यूटेशन अर इवेंट प्रोपेगेशन <a id="20-pure-functions-side-effects-state-mutation-and-event-propagation"></a>
...
## 22. हाई ऑर्डर फंक्शन <a id="22-high-order-functions"></a>
...
## 23. पुनरावर्तन <a id="23-recursion"></a>
...
## 24. कलेक्शन अर जेनरेटर <a id="24-collections-and-generators"></a>
...
## 26. एसिंक/अवेट <a id="26-asyncawait"></a>
...
## 27. डेटा स्ट्रक्चर <a id="27-data-structures"></a>
...
## 28. महंगी ऑपरेशन अर बिग O नोटेशन <a id="28-expensive-operation-and-big-o-notation"></a>
...
## 29. एल्गोरिथम <a id="29-algorithms"></a>
...
## 30. विरासत, पॉलीमॉर्फिज्म अर कोड का दोबारा इस्तेमाल <a id="30-inheritance-polymorphism-and-code-reuse"></a>
...
## 31. डिज़ाइन पैटर्न <a id="31-design-patterns"></a>
...
## 32. आंशिक एप्लीकेशन, करिंग, कंपोज़ अर पाइप <a id="32-partial-applications-currying-compose-and-pipe"></a>
...
## 33. साफ कोड <a id="33-clean-code"></a>
