<h1 align="center">
<br>
  <a href="https://github.com/leonardomso/33"><img src="https://i.imgur.com/dsHmk6H.jpg" alt="Har bir developer bilishi kerak bo'lgan 33 ta tushuncha" width=200" /></a>
  <br>
    <br>
...
[![Follow me](https://img.shields.io/twitter/follow/smnv_shokh.svg?style=for-the-badge)](https://www.instagram.com/smnv_shokh/)
...
- [Xitoycha](https://github.com/stephentian/33-js-concepts) — Re Tian
- [Brazilcha Portugalcha](https://github.com/tiagoboeing/33-js-concepts) — Tiago Boeing
- [Koreyscha](https://github.com/yjs03057/33-js-concepts.git) — Suin Lee
- [Ispancha](https://github.com/adonismendozaperez/33-js-conceptos) — Adonis Mendoza
- [Turkcha](https://github.com/ilker0/33-js-concepts) — İlker Demir
- [Ruscha](https://github.com/gumennii/33-js-concepts) — Mihail Gumennii
- [Viyetnamcha](https://github.com/nguyentranchung/33-js-concepts) — Nguyễn Trần Chung
- [Polish](https://github.com/lip3k/33-js-concepts) — Dawid Lipinski
- [Forscha](https://github.com/majidalavizadeh/33-js-concepts) — Majid Alavizadeh
- [Bahasa Indonesia](https://github.com/rijdz/33-js-concepts) — Rijdzuan Sampoerna
- [Fransuzcha](https://github.com/robinmetral/33-concepts-js) — Robin Métral
- [Hindcha](https://github.com/vikaschauhan/33-js-concepts) — Vikas Chauhan
- [Grekcha](https://github.com/DimitrisZx/33-js-concepts) — Dimitris Zarachanis
- [Yaponcha](https://github.com/oimo23/33-js-concepts) — oimo23
- [Nemischa](https://github.com/burhannn/33-js-concepts) — burhannn
- [Ukraincha](https://github.com/AndrewSavetchuk/33-js-concepts-ukrainian-translation) — Andrew Savetchuk
- [Sinhala](https://github.com/ududsha/33-js-concepts) — Udaya Shamendra
- [Italiancha](https://github.com/Donearm/33-js-concepts) — Gianluca Fiore
- [Taicha](https://github.com/ninearif/33-js-concepts) — Arif Waram
- [Katalancha](https://github.com/marioestradaf/33-js-concepts) — Mario Estrada
- [Xmercha](https://github.com/Chhunneng/33-js-concepts) — Chrea Chanchhunneng
- [Ethiopian](https://github.com/hmhard/33-js-concepts) - Miniyahil Kebede(ምንያህል ከበደ)
- [Belaruscha](https://github.com/Yafimau/33-js-concepts) — Dzianis Yafimau

---

## <a id="table-of-contents">Tarkib</a>

1. **[Chaqiruv to'plami](#1-chaqiruv-toplami)** - Call Stack
2. **[Sodda tiplar](#2-sodda-tiplar)** - Primitive Types
3. **[Qiymat tiplari va ma'lumot tiplari](#3-qiymat-tiplari-va-malumot-tiplari)**  - Value Types and Reference Types
4. **[Yashirin, Aniq, Nominal, Tuzilish va O'rdak tiplar](#4-yashirin-aniq-nominal-tuzilish-va-ordak-tiplar)** - Implicit, Explicit, Nominal, Structuring and Duck Typing
5. **[== vs === vs typeof](#5--vs--vs-typeof)**
6. **[Funksiya doirasi, Blok doirasi va Leksik doira](#6-funksiya-doirasi-blok-doirasi-va-leksik-doira)** - Function Scope, Block Scope and Lexical Scope
7. **[Ifoda va Ibora](#7-ifoda-va-ibora)** - Expression vs Statement
8. **[IIFE, Modullar va Nomlash](#8-iife-modullar-va-nomlash)** - IIFE, Modules and Namespaces
9. **[Xabarlar navbati va Hodisalar tsikli](#9-xabarlar-navbati-va-hodisalar-tsikli)** - Message Queue and Event Loop
10. **[setTimeout, setInterval va requestAnimationFrame](#10-settimeout-setinterval-va-requestanimationframe)**
11. **[JavaScript Engines](#11-javascript-engines)**
12. **[Bitli operatorlar,massivlar tipi va massiv baferlari](#12-bitli-operatorlar-massivlar-tipi-va-massiv-baferlari)** - Bitwise Operators, Type Arrays and Array Buffers
13. **[DOM va daraxtlar tartibi](#13-dom-va-daraxtlar-tartibi)** - DOM and Layout Trees
14. **[Fabrikalar va Sinflar](#14-fabrikalar-va-sinflar)** - Factories and Classes
15. **[this, call, apply va bind](#15-this-call-apply-va-bind)**
16. **[new, Constructor, instanceof va Instances](#16-new-constructor-instanceof-va-instances)**
17. **[Prototip meroslash va prototip zanjiri](#17-prototip-meroslash-va-prototip-zanjiri)** - Prototype Inheritance and Prototype Chain
18. **[Object.create va Object.assign](#18-objectcreate-va-objectassign)**
19. **[map, reduce, filter](#19-map-reduce-filter)**
20. **[Sof Funktsiyalar, Yon Ta'sirlar, Holat Mutatsiyasi va Hodisalarning Tarqalishi](#20-sof-funktsiyalar-yon-tasirlar-holat-mutatsiyasi-va-hodisalarning-tarqalishi)**  - Pure Functions, Side Effects, State Mutation and Event Propagation
21. **[Yopilishlar](#21-yopilishlar)** - Closures
22. **[Oliy Funksiyalar](#22-oliy-funksiyalar)** - High Order Functions
23. **[Rekursiya](#23-rekursiya)** - Recursion
24. **[To'plamlar va generatorlar](#24-toplamlar-va-generatorlar)** - Collections and Generators
25. **[Promises](#25-promises)**
26. **[async/await](#26-asyncawait)**
27. **[Ma'lumotlar Tuzilmalari](#27-malumotlar-tuzilmalari)** - Data Structures
28. **[Expensive Operation and Big O Notation](#28-expensive-operation-and-big-o-notation)**
29. **[Algoritmlar](#29-algoritmlar)** - Algorithms
30. **[Meroslash, Polimorfizm va Kodni Qayta Ishlatish](#30-meroslash-polimorfizm-va-kodni-qayta-ishlatish)** - Inheritance, Polymorphism and Code Reuse
31. **[Dizayn yo'llari](#31-dizayn-yollari)** - Design Patterns
32. **[Partial Applications, Currying, Compose va Pipe](#32-partial-applications-currying-compose-and-pipe)**
33. **[Toza Kod](#33-toza-kod)** - Clean Code
